...
### Tải trọng số model và file landmarks

Để hệ thống hoạt động, bạn cần tải các file sau:

1. **Trọng số mô hình (best.pt)**: [Tải tại đây](https://drive.google.com/file/d/1EIQP6N-LH-3oNf0G9aVv91Nv38edra_z/view?usp=sharing)
